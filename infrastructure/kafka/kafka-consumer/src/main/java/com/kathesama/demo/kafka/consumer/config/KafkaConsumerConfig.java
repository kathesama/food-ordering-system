package com.kathesama.demo.kafka.consumer.config;

import com.kathesama.demo.kafka.config.data.KafkaConfigData;
import com.kathesama.demo.kafka.config.data.KafkaConsumerConfigData;
